...
namespace CSharpAdvanced_Class4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            m1.RemovePartFromModule(p7);

            m1.SetDiscount(10); // 10%
            Console.WriteLine("Module 1: {0}", m1.Name);
            Console.WriteLine($"Price: {m1.GetPrice().PriceWithCurrency("EUR")}");
            ...
            m2.SetDiscount(5); // 5%
            Console.WriteLine($"Price: { m2.GetPrice().PriceWithCurrency("EUR")}");
            ...
            Console.WriteLine($"Price: {pc1.GetPrice().PriceWithCurrency("EUR")}");
            pc1.SetDiscount(5); // 5%
